      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="flex items-center mt-1">
                  <span className="bg-[#2E3944] text-xs px-2 py-1 rounded-full">Visitor</span>
                  <span className="ml-3 text-sm opacity-90">ID: V0001</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="mt-8">
              <h2 className="text-xl font-semibold text-[#212A31] mb-4">Visitor Information</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <h4 className="text-sm font-medium text-[#748D92]">Purpose</h4>
                  <p className="text-[#2E3944]">Meeting with HR</p>
                </div>
                <div>
                  <h4 className="text-sm font-medium text-[#748D92]">Host</h4>
                  <p className="text-[#2E3944]">John Smith</p>
                </div>
                <div>
