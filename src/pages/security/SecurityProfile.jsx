          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="flex flex-col">
              ...
              {isEditing ? (
                ...
                <div className="bg-blue text-white p-3 rounded-lg">{userProfile.name}</div>
              )}
            </div>
            
            <div className="flex flex-col">
              <label className="text-lg mb-2">Employee ID</label>
              <div className="bg-blue text-white p-3 rounded-lg">{userProfile.employeeId}</div>
            </div>
            ...
            <div className="flex flex-col">
              ...
              {isEditing ? (
                ...
                <div className="bg-blue text-white p-3 rounded-lg">{userProfile.designation}</div>
              )}
            </div>
            ...
            <div className="flex flex-col">
              ...
              {isEditing ? (
                ...
                <div className="bg-blue text-white p-3 rounded-lg">{userProfile.nicNumber}</div>
              )}
            </div>
            ...
            <div className="flex flex-col">
              ...
              {isEditing ? (
                ...
                <div className="bg-blue text-white p-3 rounded-lg">{userProfile.email}</div>
              )}
            </div>
            ...
            <div className="flex flex-col">
              ...
              {isEditing ? (
                ...
                <div className="bg-blue text-white p-3 rounded-lg">{userProfile.phone}</div>
              )}
            </div>
          </div>
            ...
            <div className="flex space-x-4">
              {isEditing ? (
                ...
                <>
                  <button 
                    onClick={handleEdit}
                    className="bg-blue2 text-white px-6 py-2 rounded-lg"
                  >
                    edit profile
                  </button>
                  <button 
