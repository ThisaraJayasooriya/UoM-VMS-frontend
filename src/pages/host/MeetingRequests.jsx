...
const MeetingRequests = () => {
  ...
  return (
    <div className="relative">
      <div className={`pt-20 px-4 lg:px-20 transition-all duration-300 ${isPopupOpen ? "blur-sm pointer-events-none" : ""}`}>
        <h5 className="text-2xl font-bold mb-10">You have {meetingRequests.length} meeting requests</h5>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="relative bg-white p-6 rounded-lg w-115 z-10 shadow-lg border">
              ...
              {!showAllSlots && (
                <div className="flex gap-2 items-center mb-4">
                  ...
                  <div className="mb-4">
                    ...
                    <select value={duration} onChange={(e) => setDuration(Number(e.target.value))} className="w-full p-2 border rounded bg-gray-100">
            ...
            <div className="flex justify-end mt-4 gap-3">
              <button onClick={() => handleReject(selectedMeeting.id)} className="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 font-semibold cursor-pointer">Reject</button>
              <button onClick={saveAccept} className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-semibold cursor-pointer">Accept</button>
            </div>
          </div>
        </div>
      )}
