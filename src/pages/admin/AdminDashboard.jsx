import React, { useState, useEffect } from "react";
  ...
  const AdminDashboard = () => {
    ...
    const moreActivities = [
      { id: 4, message: "Logbook exported to PDF", time: "11:20 AM", icon: <FaClipboardList className="text-white" />, color: "bg-[#124E66] p-3" },
      { id: 5, message: "User details updated", time: "11:45 AM", icon: <FaUserEdit className="text-white" />, color: "bg-[#124E66] p-3" },
      { id: 6, message: "3 new visitors pre-registered", time: "12:30 PM", icon: <FaUsers className="text-white" />, color: "bg-[#124E66] p-3" }
    ];
      ...
      useEffect(() => {
        const fetchUserSummary = async () => {
          try {
            ...
            console.log("Response:", data); // Add this to see the raw response
